...
" Read the shell output to a new buffer
" :R ls -l
...
" Read command output to a new tab
...
command! -nargs=+ -complete=command Rm call TabMessage(<q-args>)

" Delete empty buffers
" http://stackoverflow.com/a/6561076
